...
export const COPY = {
  en: {
    ...
    escalateIn: 'Not been met yet? You can notify reception in',
    escalate: 'Notify reception',
    escalating: 'Notifying…',
    escalated: 'Reception has been notified.',
  ...
  ml: {
    ...
    escalateIn: 'ആരും വന്നില്ലേ? റിസപ്ഷനെ അറിയിക്കാൻ കഴിയുന്നത്',
    escalate: 'റിസപ്ഷനെ അറിയിക്കുക',
    escalating: 'അറിയിക്കുന്നു…',
    escalated: 'റിസപ്ഷനെ അറിയിച്ചിട്ടുണ്ട്.',
